    ...
    return (
      <React.Fragment>
          <div className="bg-local">
              <div className=" py-4">
                  <div className="bg-white mr-36 float-right flex rounded-full shadow-xl w-20 h-8 md:w-52 md:h-12">
              ...
              <h2 className="ml-14 md:ml-36 pt-20 text-3xl md:text-5xl font-bold mb-2 text-white py-4" style={{ width: '570px' }}>
                  Start Your Day with Coffee and Good Meals
              </h2>
              <h3 className="ml-14 md:ml-36 text-lg md:text-xl font-bold tracking-wide mb-8 text-gray-200 py-4" style={{ width: '570px' }}>
              ...
              <button className="ml-14 md:ml-36 shadow-md text-base font-bold rounded-lg py-3 px-14 shadow-lg text-yellow-900  bg-yellow-400 hover:bg-yellow-300 tracking-wider">
                  Get Started
              </button>
          ...
          <div className=" flex justify-center items-center mx-12 md:mx-40 mt-24 md:mt-44 mb-32">
              <div className="flex flex-col md:flex-row mr-4 md:mr-10" style={{ width: '600px' }}>
                  <img src="/assets/img1.png" alt="img"/>
              </div>
              <div className="flex flex-col md:flex-row ml-4 md:ml-10" style={{ width: '500px' }}>
                  <div className="flex flex-col">
                      <h1 className="text-4xl font-semibold leading-loose">We Provide Good Coffee</h1>
                      <h1 className="text-4xl font-semibold">and Healthy Meals</h1>
                      ...
                      <ul className="container">
                          <li className="flex items-center h-12"><i className="fa fa-check-circle pr-4 text-green-500" style={{ fontSize: '25px' }}></i> High quality beans</li>
                          <li className="flex items-center h-12"><i className="fa fa-check-circle pr-4 text-green-500" style={{ fontSize: '25px' }}></i> Healthy meals, you can request the ingredients</li>
                          <li className="flex items-center h-12"><i className="fa fa-check-circle pr-4 text-green-500" style={{ fontSize: '25px' }}></i> Chat with our staff to get better experience for ordering</li>
                          <li className="flex items-center h-12"><i className="fa fa-check-circle pr-4 text-green-500" style={{ fontSize: '25px' }}></i> Free member card with a minimum purchase of IDR 200.000.</li>
                      </ul>
                  </div>
              </div>
          </div>
          ...
          <div className="bg-gray-50">
              <h1 className="text-center pt-20 text-3xl font-semibold">Here is People’s Favorite</h1>
              ...
              <div className="flex flex-row justify-center items-center mt-20 mx-36">
          ...
          <div className="bg-gray-50">
              <h1 className="text-center mx-auto pt-20 text-3xl font-semibold w-48" style={{ width: '350px' }}>Visit Our Store in the Spot on the Map Below</h1>
              <h1 className="text-center mx-auto pt-8 text-gray-600 mb-40" style={{ width: '550px' }}>See our store in every city on the spot and spen your good day there. See you soon!</h1>
          ...
          <div className="bg-gray-50 ">
              ...
              <div className="flex flex-row items-center mt-20" style={{ marginLeft: '140px' }}>
                  <div className="flex flex-col pt-3 px-6  bg-white border-gray-200 hover:border-yellow-900 border-2 rounded-lg" style={{ width: '380px', height: '230px' }}>
                      <div className="flex flex-row h-24 items-center">
                          <img src="assets/man1.png" className="h-16 w-16 rounded-full object-cover" alt=""/>
                          <div className="flex flex-col ml-5">
                              <h1 className="font-semibold">Viezh Robert</h1>
                              <h1 className="text-gray-500">Warsaw, Poland</h1>
                          </div>
                          <div className="flex flex-row ml-16">
                              <span className="font-semibold">4.5<i className="pl-3 fa fa-star text-yellow-400"></i></span>
                          </div>
                      </div>
                  ...
                  <div className="flex flex-col pt-3 px-6 mx-10 bg-white border-gray-200 hover:border-yellow-900 border-2 rounded-lg" style={{ width: '380px', height: '230px' }}>
                      <div className="flex flex-row h-24 items-center">
                          <img src="assets/man2.png" className="h-16 w-16 rounded-full object-cover" alt=""/>
                          <div className="flex flex-col ml-5">
                              <h1 className="font-semibold">Yessica Christy</h1>
                              <h1 className="text-gray-500">Shanxi, China</h1>
                          </div>
                          <div className="flex flex-row ml-16">
                              <span className="font-semibold">4.5<i className="pl-3 fa fa-star text-yellow-400"></i></span>
                          </div>
                  ...
                  <div className="flex flex-col pt-3 px-6  bg-white border-gray-200 hover:border-yellow-900 border-2 rounded-lg" style={{ width: '380px', height: '230px' }}>
                      <div className="flex flex-row h-24 items-center">
                          <img src="assets/man3.png" className="h-16 w-16 rounded-full object-cover" alt=""/>
                          <div className="flex flex-col ml-5">
                              <h1 className="font-semibold">Kim Young Jou</h1>
                              <h1 className="text-gray-500">Seoul, South Korea</h1>
                          </div>
                          <div className="flex flex-row ml-16">
                              <span className="font-semibold">4.5<i className="pl-3 fa fa-star text-yellow-400"></i></span>
                          </div>
              ...
              <div className="flex flex-col mt-20 " style={{ marginLeft: '140px' }}>
                  <div className="flex flex-row items-center">
                      ...
                      <div className="flex" style={{ marginRight: '140px' }}>
                          <div className="bg-white hover:bg-gray-100 border-2 border-yellow-900 rounded-full flex items-center justify-center w-12 h-12"><i className="fa fa-arrow-left text-yellow-900" style={{ fontSize: '20px' }}></i></div>
                          <div className="bg-yellow-900 hover:bg-yellow-800 flex items-center justify-center rounded-full ml-5 w-12 h-12"><i className="fa fa-arrow-right text-white" style={{ fontSize: '20px' }}></i></div>
                      </div>
                  </div>
              </div>
