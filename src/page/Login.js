            ...
            <div className="flex-1 flex flex-col">
                <div className="flex flex-row items-center py-8">
                  ...
                  <div className="flex flex-col items-center mx-10 md:mx-24 pt-20">
                      ...
                      {errMsg !== '' && <div className="bg-red-300 text-red-600 font-bold w-full px-5 py-5 mt-10 mx-20 rounded-full">{errMsg}</div>}
                  </div>
                  
                  <form onSubmit={this.onLogin} className="flex-1 flex flex-col mx-10 md:mx-24 pt-5">
